...
import org.web3j.abi.datatypeszoo.AbiTypes;
 ...
 * Typed {@link org.web3j.abi.datatypeszoo.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends org.web3j.abi.datatypeszoo.Type>
    ...
    public static <T extends org.web3j.abi.datatypeszoo.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends org.web3j.abi.datatypeszoo.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends org.web3j.abi.datatypeszoo.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends org.web3j.abi.datatypeszoo.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends org.web3j.abi.datatypeszoo.Type> typeClass =
        ...
        final Class<? extends org.web3j.abi.datatypeszoo.Type> baseClass =
